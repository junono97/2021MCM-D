...
# np.savetxt("1.txt",x_train.columns[selector.get_support()],fmt="%s")
print("SelectKBest select:",x_train.columns[selector.get_support()])
build_model_df(x_train_new, y_train,x_test_new, y_test)
build_model_ab(x_train_new, y_train,x_test_new, y_test)
build_model_ridge(x_train_new, y_train,x_test_new, y_test)
build_model_xgb(x_train_new, y_train,x_test_new, y_test)
# """SelectFromModel"""
SelectFromModel_df(x_train, y_train,x_test, y_test)
SelectFromModel_ab(x_train, y_train,x_test, y_test)
SelectFromModel_ridge(x_train, y_train,x_test, y_test)
SelectFromModel_xgb(x_train, y_train,x_test, y_test)